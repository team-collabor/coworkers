...
function AddBoard() {
  ...
  return (
    <>
      <Head>
        <title>게시물 작성 - Coworkers</title>
        <meta
          name="description"
          content="새로운 게시물을 작성하여 Coworkers 자유게시판에서 팀원들과 소통하세요."
        />
        <meta property="og:title" content="게시물 작성 - Coworkers" />
        <meta
          property="og:description"
          content="자유게시판에 새로운 게시물을 작성하고 팀원들과 의견을 나눠보세요."
        />
        <meta
          property="og:url"
          content="https://coworkers-colla.netlify.app/addboard"
        />
      </Head>
      <form
